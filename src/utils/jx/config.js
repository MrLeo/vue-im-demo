...
let _wap_config = {
    ...
    linkUrl: 'http://zb.test.jiuxiulvxing.com/',
...
//线上
if (_linkUrl.indexOf("zb.jiuxiulvxing.com") != -1
    || _linkUrl.indexOf("zb.hb.jiuxiulvxing.com") != -1
    || _linkUrl.indexOf("zb.9xiulvxing.com") != -1
    || _linkUrl.indexOf("app.jiuxiulvxing.com") != -1) {
    _wap_config = {
        api: "http://api.jiuxiulvxing.com/web.api",
        domainUrl: "0ce37dd6b927730161a1e559c2336d0a",
        imgUrl: "http://img.yimayholiday.com/v1/tfs/",
        linkUrl: 'http://zb.jiuxiulvxing.com/',
        contpointersApi: 'http://log.jiuxiulvxing.com/newlogwithgzip.jsp',
...
//性能测试
if (_linkUrl.indexOf("zb.xntest.jiuxiulvxing.com") != -1) {
    _wap_config = {
        api: "http://api.stest.jiuxiulvxing.com/web.api",
        domainUrl: "0ce37dd6b927730161a1e559c2336d0a",
        imgUrl: "http://img.test.yimayholiday.com/v1/tfs/",
        linkUrl: 'http://zb.xntest.jiuxiulvxing.com/',
